...
\item Estudie los distintos casos de uso de los comandos \texttt{if}, \texttt{elif} y \texttt{else} descritos en \href{https://udec.instructure.com/courses/40179/files/folder/Python?preview=2549485}{este pdf} disponible en Canvas. Realice una modificación del código de cada caso, agregando una función \texttt{input} para que se pueda ingresar el valor de \texttt{x} desde el teclado, y asegúrese que entiende la logica de cómo funciona su código.
