...
\item Modifique el programa anterior, para que ahora 'este pregunte al usuario los valores de $z_0$ y $v_0$. Para esto, use el comando \texttt{input} que aprendi'o en su trabajo con la gu'ia 11.
...
\item Realice, ahora escribiendo programas en Python, las mismas tareas planteadas en los ejercicios 3, 4, 8 y 9 de la guía 07, y además los ejercicios 2 al 9 de la sección ``Repetitivas" de la guía 08. \textbf{Indicación}: intente usar las \textbf{listas} de Python en tantos lugares como pueda, esto debiese simplificar sus programas y hacerlos más cortos y eficientes.
...
\item Realice, ahora en Python, lo planteado con los ejercicios 1 al 4 de la sección ``Condicional" de la misma guía 08. \textbf{Indicación}: intente usar las \textbf{listas} de Python.
