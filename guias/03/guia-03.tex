...
\item En \href{https://github.com/gfrubi/CC/blob/master/guias/03/ejemplo-s3.pdf}{este archivo pdf} encontrar'a el extracto de un texto simple de F'isica (Mec'anica) que hace uso ecuaciones, f'ormulas en l'inea, (sub)secciones, y diversos s'imbolos matem'aticos. Escriba un c'odigo \LaTeX que reproduzca lo m'as fielmente posible el contenido de este pdf.
\end{questions}
\end{document} 