...
\begin{document}
\title{Introducción a GNU/Linux}
\author{Guillermo Rubilar}
\institute{\tiny [Confeccionado usando parte del código fuente disponible en \url{https://github.com/giomba/beamer-intro-linux} y \\ \url{https://github.com/alexpacheco/linux}]}
\date{\today}
...
\begin{frame}
    ...
    \begin{block}{Software libre}
        \begin{enumerate}
        \setcounter{enumi}{-1}
        \item Libertad de usar el programa para cualquier propósito
        ...
        \begin{block}{El problema}
            \begin{itemize}
                ...
                \item
                    ...
                    \begin{minipage}{.85\linewidth} Instala \href{https://es.wikipedia.org/wiki/MINIX}{Minix-Unix} en su PC \end{minipage}
                    \pause
                \item
...
\end{center}
    ...
    \begin{column}{.25\textwidth}
        \includegraphics[width=.9\linewidth]{figs/router.jpg}
...
\begin{frame}
    ...
    \end{itemize}
    \begin{minipage}[b][.18\textheight][t]{.18\textwidth}
    ...
    \end{minipage}\hfill
    \begin{minipage}[b][.18\textheight][t]{.18\textwidth}
    \includegraphics[width=0.7\textwidth]{figs/logo-manjaro.png}
    \centering Manjaro
    \end{minipage}\hfill
    \begin{minipage}[b][.18\textheight][t]{.18\textwidth}
...
\texttt{tar, gzip, nano, ssh, history, !, locate, wc}.
\end{block}
\end{frame}
\end{document}
