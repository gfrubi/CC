...
\end{center}
    ...
    \begin{itemize}
        ...
        \item
            \begin{minipage}{.10\linewidth} \visible<2->{\includegraphics[width=.5\linewidth]{figs/servers.png}} \end{minipage} Soporte multiprocesadores y  multiplataforma \pause
        \item
