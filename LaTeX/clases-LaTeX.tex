...
\begin{itemize}
\item \href{https://es.wikipedia.org/wiki/TeX}{\TeX{}} (1978) es un sistema profesional de \emph{composici'on tipogr'afica} desarrollado
...
\item Indispensable para f'isic@s, geof'isic@s, astr'onom@s, matem'atic@s, et., especialmente para investigador@s.
...
\section{Matem'aticas con \LaTeX}
...
\begin{frame}[fragile]\frametitle{Extendiendo \LaTeX\ paquetes/m\'odulos adicionales}
\begin{block}{}
...
En general, cada paquete particular que quiera ser usado en un documento debe ser cargado en el pre\'ambulo del documento, es decir, \textit{antes} del comando \verb|\begin{document}|
\end{block}
\begin{block}{}
\begin{minted}{tex}
...
\begin{itemize}
  ...
  \item Recomiendo Inkscape, Python, LibreOffice  para crear \textit{gr'aficos vectoriales} (.svg, .ps, .eps, .pdf); Gimp para fotos (.png, .jpg).
\end{itemize}
\end{frame}
