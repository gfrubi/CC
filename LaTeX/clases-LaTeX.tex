...
\end{block}
\begin{block}{}
El paquete Babel se encarga de gestionar los cortes de palabras al final de las líneas (muy \'util!). La opción \texttt{spanish} selecciona nuestro idioma, y \texttt{activeacute} permite acortar un poco la introducción de tildes y caracteres latinos
\end{block}
\begin{block}{}
\begin{minted}{tex}
'a, é, í, 'o, 'u, ~n, 'N, ?` y !`
...
\begin{frame}[fragile]\frametitle{Presentaciones}
	\begin{itemize}
