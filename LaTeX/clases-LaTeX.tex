...
\begin{frame}[fragile]\frametitle{Arreglos y matrices}
\begin{itemize}
  \item Los comandos \verb|\left| y \verb|\right| agregan par'entesis que se adaptan al tama\~no del conenido que encierran. Se pueden usar combinaciones de: \verb|(|, \verb|)|, \verb|[|, \verb|]|,    \verb|\{|, \verb|\}|, \verb#|# y \verb|.|
