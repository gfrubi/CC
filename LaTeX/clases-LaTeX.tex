...
\begin{frame}[fragile]\frametitle{Presentaciones con Beamer}
	\begin{itemize}
		\item La clase \href{https://github.com/josephwright/beamer}{\texttt{beamer}} permite crear presentaciones 
			\begin{block}{}
			\begin{minted}{tex}
				\documentclass{beamer}
			\end{minted}
			\end{block}
		\item Recomiendo usar las opciones \verb|[hyperref={colorlinks},aspectratio=169]|.

		\item Cada lámina/página es creada usando el entorno \texttt{frame}.
		\item Puede definir un ``bloque'', usando el entorno \texttt{block}.
		\item Puede también cambiar el tipo de letra usada, por ejemplo con \verb|\usefonttheme{professionalfonts}|.
		\item Puede cambiar el aspecto general con \verb|\usetheme{Darmstadt}|.
		\item Temas disponibles (ver \href{https://ctan.dcc.uchile.cl/macros/latex/contrib/beamer/doc/beameruserguide.pdf}{manual}): Bergen, Boadilla, Copenhagen, Dresden, Hannover, Luebeck, AnnArbor, Berkeley, Darmstadt, Frankfurt, Ilmenau, Madrid, Warsaw, Antibes, Berlin, CambridgeUS, Malmoe, PaloAlto.
